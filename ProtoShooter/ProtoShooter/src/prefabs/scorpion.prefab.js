{
    ...
    scripts:{scorpionLogic:{}, enemyDraw:{resId:"scorpionSprite"}, gun:{spawnX:100, spawnY:5, projectile:"samusBullet", targetGroup:"hero"}, health:{health:3}, stiffTriggerFollow:{xOffset:-400, yOffset:-400}}, 
    renderers:[
    ],
